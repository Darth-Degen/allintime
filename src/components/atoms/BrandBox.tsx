...
const BrandBox: FC = () => {
  return (
    <div className="border-4 border-white w-[400px] xl:w-[500px] bg-custom-black">
      ...
      <div className="w-full text-center flex flex-col items-center justify-center py-3 px-5 xl:py-5 xl:px-20">
